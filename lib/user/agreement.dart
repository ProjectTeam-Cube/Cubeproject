import 'package:cube/user/sign_up.dart';
          ...
          child: Align(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Column(
                    // 여러 텍스트를 추가하기 위해 Column을 사용합니다
                    mainAxisAlignment:
                        MainAxisAlignment.center, // 텍스트를 세로 중앙 정렬
                    children: [
                      Text(
                        '약관동의',
                        style: TextStyle(
                            ...
                            child: Padding(
                              ...
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  ...
                                  backgroundColor:
                                      const Color(0xFFFF6F0F), // 버튼 배경색
                                  padding: const EdgeInsets.symmetric(
                                      horizontal: 156,
                                      vertical: 24), // 버튼의 내부 패딩
